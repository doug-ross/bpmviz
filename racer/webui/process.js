(function(){
  ...
  const lanes=[
    {id:"ext",  name:"GBIS / Holsen", role:"Ext. Feeds", type:"ext"},
  ...
  const before={
    nodes:[
      ...
      N("ext",   COL(5),"task", "Send txn feeds","GBIS+Holsen 5min",300,305),
      ...
      N("sys",   COL(7),"task", "Confirm & post","Holsen+ledger",650,710),
  ...
  const after={
    nodes:[
      ...
      N("ai",   COL(7),"task", "Post & confirm","Holsen+ledger",26,34,{agent:true,role:"AI"}),
